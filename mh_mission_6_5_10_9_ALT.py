...
async def run_6(robot):
  ...
  robot.Drive.settings(turn_rate=350)
  ...
  await robot.Drive.straight(140)    #reach the who lives there station changed from 144
  ...
  await robot.Right_attach.run_angle(500,-67.2) #bring the hammer down to Whats on Sale
  
  robot.Drive.settings(straight_speed=100)
  await robot.Drive.straight(220) #whats on sale

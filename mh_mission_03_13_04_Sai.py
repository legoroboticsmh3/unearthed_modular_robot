...
async def run_3(robot):
    ...
    await robot.Drive.straight(-70) # Going back to allow the angle adjustment.
    await robot.Drive.turn(-2)


    await robot.Left_attach.run_angle(300,-250)
    await robot.Right_attach.run_angle(300,-280)
    ...
    await robot.Drive.straight(96)
    await robot.Left_attach.run_angle(300,60)
